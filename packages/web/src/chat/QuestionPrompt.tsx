 ...
 * prompt) shows its options; single-select picks one label, multi-select toggles a set. Submit returns
 * the answers map (question text -> chosen label | label[]); Skip cancels (the server denies the tool).
 */
